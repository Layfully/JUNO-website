...
intends to excite people for the fascinating world of particle physics.</li>
      ...
      <footer className={styles.footer, "wave-container text-center relative"}>
        <div className="absolute bottom-0">
          <svg svg width="1920" height="1200" viewBox="0 0 1920 1200" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="relative px-8">
          <h1 className="text-6xl text-white text-opacity-50 font-mono font-bold mb-16" >Learn more about: </h1>
